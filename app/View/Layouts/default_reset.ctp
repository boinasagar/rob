...
<html lang="en">
  <head>
    ...
    ?>
	<script src="/greencard/js/jquery-ui-1.11.4/jquery-ui.js" type="text/javascript" /></script>
	<link href="/greencard/js/jquery-ui-1.11.4/jquery-ui.min.css" rel="stylesheet" type="text/css" />
	<link href="/greencard/js/jtable/themes/lightcolor/red/jtable.css" rel="stylesheet" type="text/css" />
<script src="/greencard/js/jtable/jquery.jtable.min.js" type="text/javascript"></script>
...
<div id='ajaxstatus' style='display:none;'><nobr><img src='/greencard/images/loading.gif' border=0 ></nobr></div>
<div id="cover" > </div>
